...
for jj=1:M
    ...
    %Brukerdensistevariantenforfsvakepartierbedresynlig
    fbrukt(jj)=f_analyse; %Lagrerfrekvensenesomfaktiskerbrukt
    f_analyse=f_analyse*ftrinn; %Beregnernestefrekvens
end;
%Redusererfilstrrelsevedfjernemyeavoverfldiginformasjonitid.
%Dettegjreskunforatfilstrrelsenpplotteneskalblihndterbar.
...
%Foretaenmarkeringiplottetforviseomrdermedrandproblemer
...
%title('WaveletPowerSpektrum');%Velgdennenrdeteraktuelt,
title('Sqrt(WaveletPowerSpektrum)');%mendennenrsqrtblirbrukt
