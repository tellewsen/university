...
stddevflatsquarefinal = findgen(7)
...
Df = (darkflat1/5.0+darkflat2/5.0+darkflat3/5.0+darkflat4/5.0+darkflat5/5.0) ;Master darkframe
Ddiff = (dark1/5.0+dark2/5.0+dark3/5.0+dark4/5.0+dark5/5.0)
F = (flat3/14.0+flat4/14.0+flat5/14.0+flat6/14.0+flat7/14.0+flat8/14.0+flat9/14.0+flat10/14.0+flat11/14.0+flat12/14.0+flat13/14.0+flat14/14.0+flat15/14.0+flat16/14.0) ;Master flatfield
m = avg(F-Df)
Corrected = (Rawimage-Ddiff)*m /(F-Df)
