...
for k in range(n):
	...
	figure(0)
	plot(t,x, t,v, t,a, axis=[0,t[k],0,x[k]], legend=['x(t)','v(t)','a(t)'], xlabel='Time[t]', ylabel='x[m],v[m/s],a[m/s**2]', hardcopy="plotOppgaveI.png")
	figure(1)
	plot(t,F, t,Fc, t,Fv, t,D, axis=[0,t[k+1],-10,10+Fc[1]],legend=['F(t)','Fc(t)','Fv(t)','D(t)'],xlabel='Time[t]', ylabel='Force', hardcopy="plotOppgaveK.png")
        break
